        ...
        <div class="flex flex-col">
            ...
            <div class="flex justify-center items-center mt-5 w-full">
                <a href="https://dev-kimchi.tistory.com" target="blank"
                    class="text-xl mr-2 hover:bg-gray-300 transition-all duration-500 w-12 h-12 flex justify-center items-center rounded-2xl text-black">
                ...
                <a href="https://github.com/aleph-kim" target="blank"
                    class="text-2xl hover:bg-gray-300 transition-all duration-500 w-12 h-12 flex justify-center items-center rounded-2xl text-black">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
