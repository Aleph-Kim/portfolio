                        ...
                        <div class="w-full md:w-1/2">
                            ...
                            <div class="flex gap-4 mb-4">
                                ...
                                <a v-if="project.github" :href="project.github" target="_blank"
                                    class="inline-flex items-center gap-2 px-4 py-2 bg-gray-800 hover:bg-gray-700 text-white rounded-lg transition-all duration-300 transform hover:shadow-lg no-underline">
