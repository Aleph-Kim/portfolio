<template>
    <section class="section flex items-center justify-center flex-col mt-40">
        <!-- About -->
        <div class="mt-10">
            ...
            <JobCard company="멋쟁이사자처럼" role="프리랜서 보조강사" period="2024.04 ~ 2024.09 (5개월)"
                ...
                :projects="[
                    { title: '백엔드 스쿨 10기 보조강사', description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur, aut. Veniam voluptates nostrum voluptatem illo libero voluptatibus autem quibusdam fugiat laborum nam qui, corporis, et, cum officia? Vel, laudantium maiores!' }
