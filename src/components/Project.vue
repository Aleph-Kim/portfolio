        ...
        <div class="container mx-auto px-4">
            <div class="max-w-7xl mx-auto">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div v-for="project in projects" :key="project.id" data-aos="fade-down" data-aos-duration="800">
                        <div
                            class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden transform transition-all duration-300 hover:bg-gray-100 hover:dark:bg-gray-700 hover:shadow-xl cursor-pointer group"
                            ...
                            <div class="p-8">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <span @click="openModal(project)"
                                        class="inline-block px-7 py-2.5 border-2 border-gray-300 dark:border-gray-700 rounded-md bg-gray-50 dark:bg-gray-800 dark:text-gray-100 group-hover:bg-gray-100 dark:group-hover:bg-gray-700 group-hover:border-gray-400 dark:group-hover:border-gray-500 transition-colors duration-200 cursor-pointer text-base text-center border-solid">
                                        상세 설명
                                    </span>
                                </div>
                            </div>
